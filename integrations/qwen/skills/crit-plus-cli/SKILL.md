...
crit-plus comment --author 'Qwen' '<body>'

# File-level (whole file, no line numbers)
crit-plus comment --author 'Qwen' <path> '<body>'

# Line (single line or range)
crit-plus comment --author 'Qwen' <path>:<line> '<body>'
crit-plus comment --author 'Qwen' <path>:<start>-<end> '<body>'

# Reply to an existing comment
crit-plus comment --reply-to <id> --author 'Qwen' '<body>'
```
...
]' | crit-plus comment --json --author 'Qwen'
```
...
```bash
crit-plus comment --json --file /tmp/crit-plus-bulk.json --author 'Qwen'
```
...
```bash
crit-plus comment --reply-to c_a1b2c3 --path src/auth.go --author 'Qwen' 'Fixed the null check'
```
...
```bash
crit-plus comment --plan my-plan-2026-03-23 --reply-to c_a1b2c3 --author 'Qwen' 'Updated the plan'
```
