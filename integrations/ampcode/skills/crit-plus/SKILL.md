...
## Step 2: Launch crit-plus and block until review completes

**CRITICAL — you MUST run this step. Do NOT skip it. Do NOT proceed without it.**

Run `crit-plus` in the foreground and block until it exits:
...
**Do NOT proceed until `crit-plus` completes.** Do NOT ask the user to type anything. Do NOT read the review file early. Wait for the foreground command to finish — that is how you know the human is done reviewing.
...
4. Reply with what you did: `crit-plus comment --reply-to <id> --author 'Amp' '<what you did>'` (reply bodies support markdown)
