...
allowed-tools: Bash(crit-plus:*), Bash(crit-plus story:*), Bash(crit-plus comment:*), Read, Edit
argument-hint: ""
---
...
Story ingest opens the review UI and exits — it does **not** wait for the human. Run `crit-plus` **in the background** using `run_in_background: true`:
