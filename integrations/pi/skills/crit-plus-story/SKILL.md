...
description: "Author a crit-plus story and continue the interactive review loop only when the user explicitly invokes /skill:crit-plus-story or directly asks you to generate a crit-plus story. Do not infer this skill from generic review, PR, or diff-review requests."
---
