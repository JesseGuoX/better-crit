...
Use this workflow only when the user explicitly invokes `/crit-plus-story` (or this
workflow) or directly asks you to generate a crit-plus story. Do not infer it from
`/crit-plus.md`, a PR review, or a generic "review this" request.
