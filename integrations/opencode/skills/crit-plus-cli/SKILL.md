...
crit-plus comment --author 'OpenCode' '<body>'

# File-level (whole file, no line numbers)
crit-plus comment --author 'OpenCode' <path> '<body>'

# Line (single line or range)
crit-plus comment --author 'OpenCode' <path>:<line> '<body>'
crit-plus comment --author 'OpenCode' <path>:<start>-<end> '<body>'

# Reply to an existing comment
crit-plus comment --reply-to <id> --author 'OpenCode' '<body>'
```
...
```bash
crit-plus comment --json --file /tmp/crit-plus-bulk.json --author 'OpenCode'
```
...
```bash
crit-plus comment --reply-to c_a1b2c3 --path src/auth.go --author 'OpenCode' 'Fixed the null check'
```
...
```bash
crit-plus comment --plan my-plan-2026-03-23 --reply-to c_a1b2c3 --author 'OpenCode' 'Updated the plan'
```
