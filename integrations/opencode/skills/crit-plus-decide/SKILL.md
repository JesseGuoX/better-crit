---
name: crit-plus-decide
description: Collect structured human choices with Crit Plus when the user wants to select proposals, adjudicate open questions, or give revision feedback in a decision page. Supports partial submissions and follow-up rounds.
---

# Collect decisions with Crit Plus
